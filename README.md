...
<h3 align="center">project_title</h3>
  ...
  <p align="center">
    ...
    <br />
    <br />
    <a href="https://github.com/Version-LAA/techtrek">View Demo</a>
    ·
    <a href="https://github.com/Version-LAA/techtrek/issues">Report Bug</a>
    ·
    <a href="https://github.com/Version-LAA/techtrek/issues">Request Feature</a>
...
Here's a blank template to get started: To avoid retyping too much info. Do a search and replace with your text editor for the following: `Version-LAA`, `techtrek`, `twitter_handle`, `linkedin_username`, `email_client`, `email`, `project_title`, `project_description`
...
To successfully set up the project locally please perform the following actions.
...
2. Clone the repo
   ```sh
   git clone https://github.com/Version-LAA/techtrek.git
   ```
